...
export const DESCRIPTIONS: string[] = [
  ...
  "DataFlow: Create, Chain, Communicate.",
  ...
  "Design Dialogues with DataFlow.",
...
export const API_PAGE_PARAGRAPH =
  "Your secret DataFlow API keys are listed below. Do not share your API key with others, or expose it in the browser or other client-side code.";
...
export const LANGFLOW_CHAT_TITLE = "DataFlow Chat";
...
export const STORE_TITLE = "DataFlow Store";
export const NO_API_KEY = "You don't have an API key.";
export const INSERT_API_KEY = "Insert your DataFlow API key.";
